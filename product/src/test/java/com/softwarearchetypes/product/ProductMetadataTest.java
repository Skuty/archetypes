...
class ProductMetadataTest {
    ...
    void shouldAddMetadataImmutably() {
        ProductMetadata metadata1 = ProductMetadata.empty();
        ProductMetadata metadata2 = metadata1.with("category", "coffee");
        ProductMetadata metadata3 = metadata2.with("seasonal", "true");
