...
class ProductType implements Product {
    ...
    /**
     * Returns a builder for ProductType with specified tracking and measurement parameters.
     * This is a convenience method that delegates to Product.builder().asProductType().
     */
    static ProductBuilder.ProductTypeBuilder builder(ProductIdentifier id,
                                                     ProductName name,
                                                     ProductDescription description,
                                                     Unit preferredUnit,
                                                     ProductTrackingStrategy trackingStrategy) {
