...
public class AccountingFacade {
    ...
    public Optional<Money> balance(AccountId accountId) {
        ...
        return accountViewQueries.find(accountId).map(AccountView::balance);
    }
    ...
    public List<AccountView> findAccounts(Set<AccountId> accountIds) {
        return accountViewQueries.find(accountIds).values().stream().toList();
    }

    public List<AccountView> findAll() {
        return accountViewQueries.findAll();
    }
...
interface AccountRepository {
    ...
    Optional<ProjectionAccount> findProjectionAccount(AccountId accountId);
    ...
    Map<AccountId, ProjectionAccount> findProjectionAccounts(Set<AccountId> accounts);

    List<ProjectionAccount> findAllProjectionAccounts();
}
...
class InMemoryAccountRepo implements AccountRepository {
    ...
    @Override
    public Optional<ProjectionAccount> findProjectionAccount(AccountId accountId) {
        return Optional.ofNullable(projectionAccounts.get(accountId));
    }
    ...
    @Override
    public List<ProjectionAccount> findAllProjectionAccounts() {
        return new ArrayList<>(projectionAccounts.values());
    }
